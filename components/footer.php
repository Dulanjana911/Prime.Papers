<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:ds.studios01@gmail.com"><i class="fas fa-envelope"></i> ds.studios01@gmail.com</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> Colombo10, Sri Lanka </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>S.G.V Senarathne</span> | all rights reserved!</div>
